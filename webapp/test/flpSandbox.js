		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Vendor Portal",
									"targetURL": "#uitmvpsztmvpsintutive-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uitmvpsztmvpsintutive-display": {
								"semanticObject": "uitmvpsztmvpsintutive",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.tm.vps.ztmvpsintutive",
									"url": sap.ui.require.toUrl("ui/tm/vps/ztmvpsintutive")
								}
							}
						}
					}
